...
func TestNormalization(t *testing.T) {
    assert.Equal(t, 10, normalizeAngle(370))
    assert.Equal(t, 0, normalizeAngle(720))
    assert.Equal(t, 10, normalizeAngle(-350))
    assert.Equal(t, 0, normalizeAngle(-720))
    assert.Equal(t, -170, normalizeAngle(190))
    assert.Equal(t, 170, normalizeAngle(-190))
    assert.Equal(t, 180, normalizeAngle(-180))
    assert.Equal(t, 180, normalizeAngle(180))
}
